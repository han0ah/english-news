...
function add_logout_link( $items, $args ) {
    if (is_user_logged_in() /*&& $args->theme_location == 'primary-menu'*/) {
    	...
    	$items .= '<li class="right-menu-item menu-item"><a href="'. get_admin_url() .'">관리하기</a></li>';
    	$items .= '<li class="right-menu-item menu-item"><a href="'. get_admin_url(null,'post-new.php','admin') .'">새글쓰기</a></li>';
    }
    return $items;
}
